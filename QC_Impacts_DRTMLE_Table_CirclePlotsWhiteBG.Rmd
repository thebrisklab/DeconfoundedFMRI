...
myChordDiagram = function(data,varname,alpha=0.20,alphaname,title) {
  ...
  oDATA$NewOrder[oDATA$Group=="Attn"]=1
  oDATA$NewOrder[oDATA$Group=="Control"]=5
  oDATA$NewOrder[oDATA$Group=="SalVenAtt"]=6
  oDATA$NewOrder[oDATA$Group=="SC"]=3
  oDATA$NewOrder[oDATA$Group=="Default"]=4
  oDATA$NewOrder[oDATA$Group=="SomMot"]=7
  oDATA$NewOrder[oDATA$Group=="Vis"]=2
