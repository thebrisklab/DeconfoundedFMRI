...
#### Determine edges showing a significant group difference
```{r}
...
fdr05.td.edges.SL = which(results.ave$td.p.SL.fdr<.05) 
fdr05.td.edges.naive = which(results.ave$td.p.naive.fdr<.05) 

fdr20.td.edges.SL = which(results.ave$td.p.SL.fdr<.20) 
fdr20.td.edges.naive = which(results.ave$td.p.naive.fdr<.20) 
