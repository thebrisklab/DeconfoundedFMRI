...
#### Naive TD Z-Statistic FDR=0.05
```{r, fig.width=5, fig.height=5}
png("Application_Figures/Naive_zstat_TD_fdr05.png",width=5,height=5,units="in",res=200)

myChordDiagram(data=results.ave,varname='z.stat.TD.naive',alpha=0.05,alphaname='td.p.naive.fdr', title='')
dev.off()

circos.clear()

myChordDiagram(data=results.ave,varname='z.stat.TD.naive',alpha=0.05,alphaname='td.p.naive.fdr',title='A. Naive Z-Statistic, TD, FDR=0.05')
