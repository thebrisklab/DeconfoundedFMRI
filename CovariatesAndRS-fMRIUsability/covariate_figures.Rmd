...
graph %>% export_svg() %>% 
  charToRaw() %>% 
  rsvg_png("Figures/exclusionFlowChart.png", width = 1500, heigh = 300)
...
```{r, echo=F, message=FALSE, warning=FALSE, fig.width = 4, fig.height = 2}
png("Figures/fig_propExcluded_cc.png",width=4,height=2,units="in",res=200)
cowplot::plot_grid(dx_proportions, prop_legend, nrow=2, rel_heights = c(1, .1))
invisible(dev.off())

complete_props <- cowplot::plot_grid(dx_proportions, prop_legend, nrow=2, rel_heights = c(1, .1))
complete_props
