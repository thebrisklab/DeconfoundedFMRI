...
graph %>% export_svg() %>% 
  charToRaw() %>% 
  rsvg_png("Figures/exclusionFlowChart.png", width = 1500)

```
NOTE: still exports .png despite this message
...
tabSex<- tableby( PrimaryDiagnosis~Sex, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
###Age
```{r, results="asis"}
tabAge<- tableby( PrimaryDiagnosis~AgeAtScan, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
###Race
```{r, results="asis"}
tabRace<- tableby( PrimaryDiagnosis~Race2, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="fe"))
...
###SES
```{r, results="asis"}
tabSES<- tableby( PrimaryDiagnosis~SES.Family, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
tabHand<- tableby( PrimaryDiagnosis~handedness, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
tabStim<- tableby( PrimaryDiagnosis~CurrentlyOnStimulants, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
###Impact of motion QC on phenotypic representation within diagnostic groups
```{r}
...
####Mann-Whitney U tests to compare included vs excluded participants
```{r}
...
###Univariate analysis of rs-fMRI exclusion probability as a function of covariates across diagnostic groups
```{r}
