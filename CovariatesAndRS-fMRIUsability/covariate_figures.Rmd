...
qcMelt <- filter(qcMelt, CompletePredictorCases==1)

nCompleteCases <- qcMelt %>% 
  filter(Motion.Exclusion.Level=="Lenient") %>%
  nrow()

nCompleteCasesASD <- qcMelt %>% 
  filter(Motion.Exclusion.Level=="Lenient") %>% 
  filter(PrimaryDiagnosis=="ASD") %>% 
  nrow()

nCompleteCasesTD <- qcMelt %>% 
  filter(Motion.Exclusion.Level=="Lenient") %>% 
...
#check that all scans that passed strict also passed moderate
nPassStrictNotLenient = length(dat3$Ciric_length[dat3$Ciric_length=="Pass" & dat3$KKI_criteria=="Fail"])

grViz("digraph flowchart {
      graph [layout = dot, rankdir = LR]
      # node definitions with substituted label text
      node [fontname = Helvetica, shape = rectangle, style = rounded, fontsize = 18, fixedsize = TRUE, width = 3, height = 1]    
#attempted
      tab1 [label = '@@1']
...
#all covariates collected -> passed lenient QC
      tab2 -> tab3 [fontname = Helvetica, fontsize = 18, fontcolor = LightSlateGray, label = '@@4'];
#all covariates collected -> passed strict QC
      tab2 -> tab4 [fontname = Helvetica, fontsize = 18, fontcolor = LightSlateGray, label = '@@6'];
      }
      
      [1]: paste0('Scans Attempted', '\\n', 'n = ', nAttempted, '\\n', nAttemptedASD, ' ASD, ' , nAttemptedTD, ' TD')
      [2]: paste0('Complete Predictor Cases', '\\n', 'n = ', nCompleteCases, '\\n', nCompleteCasesASD, ' ASD, ' , nCompleteCasesTD, ' TD')
...
####Check consistency of Diagnosis variables
```{r}
...
###Summarize sociodemographic info for paper
```{r,  results="asis"}
levels(qcMelt$Motion.Exclusion.Level) = c("None", "Lenient", "Strict")
...
none<- tableby( PrimaryDiagnosis~Sex, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

len<- tableby( PrimaryDiagnosis~Sex, data=filter(qcMelt, Motion.Exclusion.Level=="Lenient"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

str<- tableby( PrimaryDiagnosis~Sex, data=filter(qcMelt, Motion.Exclusion.Level=="Strict"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

summary(none, digits=2, digits.p=4,digits.pct=1,text=NULL,  numeric.simplify=TRUE, total=FALSE, title="None")
summary(len, digits=2, digits.p=4,digits.pct=1,text=NULL,  numeric.simplify=TRUE, total=FALSE, title="Lenient")
summary(str, digits=2, digits.p=4,digits.pct=1,text=NULL,  numeric.simplify=TRUE, total=FALSE, title="Strict")
...
###Age
```{r, results="asis"}
none<- tableby( PrimaryDiagnosis~AgeAtScan, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

len<- tableby( PrimaryDiagnosis~AgeAtScan, data=filter(qcMelt, Motion.Exclusion.Level=="Lenient"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

str<- tableby( PrimaryDiagnosis~AgeAtScan, data=filter(qcMelt, Motion.Exclusion.Level=="Strict"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
###Race
```{r, results="asis"}
none<- tableby( PrimaryDiagnosis~Race2, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="fe"))

len<- tableby( PrimaryDiagnosis~Race2, data=filter(qcMelt, Motion.Exclusion.Level=="Lenient"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="fe"))

str<- tableby( PrimaryDiagnosis~Race2, data=filter(qcMelt, Motion.Exclusion.Level=="Strict"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="fe"))
...
###SES
```{r, results="asis"}
none<- tableby( PrimaryDiagnosis~SES.Family, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

len<- tableby( PrimaryDiagnosis~SES.Family, data=filter(qcMelt, Motion.Exclusion.Level=="Lenient"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

str<- tableby( PrimaryDiagnosis~SES.Family, data=filter(qcMelt, Motion.Exclusion.Level=="Strict"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
none<- tableby( PrimaryDiagnosis~handedness, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

len<- tableby( PrimaryDiagnosis~handedness, data=filter(qcMelt, Motion.Exclusion.Level=="Lenient"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

str<- tableby( PrimaryDiagnosis~handedness, data=filter(qcMelt, Motion.Exclusion.Level=="Strict"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))
...
none<- tableby( PrimaryDiagnosis~CurrentlyOnStimulants, data=filter(qcMelt, Motion.Exclusion.Level=="None" & Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

len<- tableby( PrimaryDiagnosis~CurrentlyOnStimulants, data=filter(qcMelt, Motion.Exclusion.Level=="Lenient"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

str<- tableby( PrimaryDiagnosis~CurrentlyOnStimulants, data=filter(qcMelt, Motion.Exclusion.Level=="Strict"& Included=="Included"), control=tableby.control(numeric.test="kwt", cat.test="chisq"))

summary(none, digits=2, digits.p=4,digits.pct=1,text=NULL,  numeric.simplify=TRUE, total=FALSE, title="None", test=FALSE)
summary(len, digits=2, digits.p=4,digits.pct=1,text=NULL,  numeric.simplify=TRUE, total=FALSE, title="Lenient", test=FALSE)
summary(str, digits=2, digits.p=4,digits.pct=1,text=NULL,  numeric.simplify=TRUE, total=FALSE, title="Strict", test=FALSE)

```


###Proportion of children excluded
```{r, results='hide'}
#Easier to make three separate panels and combine them then to use faceting function
...
####Currently on stimulants in ASD group
```{r}
...
####Secondary ADHD diagnosis in ASD group
```{r}
...
####Combine proportion plots into one figure & save
```{r, echo=F, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3}
props <- cowplot::plot_grid(dx_proportions, stim_proportions, comorbid_proportions, ncol=3, 
                   rel_widths=c(1/3, 1/3, 1/3), labels = c("A","B", "C"))
png("Figures/fig_propExcluded_cc.png",width=8,height=3,units="in",res=200)
cowplot::plot_grid(props, prop_legend, ncol=2, rel_widths = c(1, .1))
invisible(dev.off())

complete_props <- cowplot::plot_grid(props, prop_legend, ncol=2, rel_widths = c(1, .1))
```

###Within group distributions of phenotypic variables
...
NOTE: 183/3 = 91, # of participants missing SRS
...
aim1MW <- aim1tib %>% 
  group_by(variable, PrimaryDiagnosis, Motion.Exclusion.Level) %>% 
  tidyr::nest()
...
nested_less <- nested_mw[-c(2,4,21:28),]
...
nested_g <- nested_mw[-c(1:20),]

complete_mw <- rbind(nested_g, nested_less)

complete_mw$p.fdr <- p.adjust(complete_mw$p.value, method = "BH")

complete_asd_mw <- complete_mw %>% filter(PrimaryDiagnosis=="ASD") %>% dplyr::select(-c("data", "mwm", "statistic", "p.value"))

complete_td_mw <- complete_mw %>% filter(PrimaryDiagnosis=="TD") %>% dplyr::select(-c("data", "mwm", "statistic", "p.value"))
...
nested_gams$p.fdr <- p.adjust(nested_gams$p.value, method = "BH")
...
##Probability of exclusion as a function of ADOS
```{r}
ados <- nested_gams %>% 
...
##Probability of exclusion as a function of SRS
```{r}
srs <- nested_gams %>% 
  filter(variable=="SRS") %>% 
  select("variable", "Motion.Exclusion.Level", "range", "fit", 'lCI', 'hCI') %>% 
...
##Probability of exclusion as a function of Inattention
```{r}
ina <- nested_gams %>% 
...
##Probability of exclusion as a function of Hyperactivity
```{r}
hi <- nested_gams %>% 
...
##Probability of exclusion as a function of Motor Overflow
```{r}
mo <- nested_gams %>% 
...
##Probability of exclusion as a function of Age
```{r}
age<- nested_gams %>% 
  filter(variable=="Age") %>% 
  select("variable", "Motion.Exclusion.Level", "range", "fit", 'lCI', 'hCI') %>% 
...
##Probability of exclusion as a function of GAI
```{r}
gai <- nested_gams %>% 
  filter(variable=="GAI") %>% 
  select("variable", "Motion.Exclusion.Level", "range", "fit", 'lCI', 'hCI') %>% 
...
##Hyperactivity/Impulsivity Density
```{r}
ddata <- nested_gams %>% 
  filter(variable=="Hyperactivity") %>% 
  filter(Motion.Exclusion.Level=="Lenient") %>% 
...
##Edgewise functional connectivity as a function of the behavioral covariates
```{r}
