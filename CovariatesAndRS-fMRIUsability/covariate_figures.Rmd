...
49 Autism (only) + 353 None = 402 ADHD_Secondary=0
...
summary(tabN,  
        title='Proportion of complete cases excluded by motion QC',digits=0, digits.p=4,digits.pct=1, numeric.simplify=TRUE, total=FALSE, test=FALSE)

levels(completeCases$Diagnosis4Levels)[levels(completeCases$Diagnosis4Levels)=="Autism"]="ASD-only"
levels(completeCases$Diagnosis4Levels)[levels(completeCases$Diagnosis4Levels)=="Autism+ADHD"]="ASD+ADHD"
levels(completeCases$Diagnosis4Levels)[levels(completeCases$Diagnosis4Levels)=="None"]="TD"



tabASDonly<- tableby(Motion.Exclusion.Level~Included, data=filter(completeCases,
                                                                    Diagnosis4Levels=="ASD-only"))

summary(tabASDonly,  
        title = "Proportion of ASD-only participants included/excluded",
...
tabASDco<- tableby(Motion.Exclusion.Level~Included, data=filter(completeCases,
                                                                    Diagnosis4Levels=="ASD+ADHD"))

summary(tabASDco,  
        title = "Proportion of ASD+ADHD participants included/excluded",
        digits=0, digits.p=4,digits.pct=1, numeric.simplify=TRUE, total=FALSE, test=FALSE)
...
summary(tabTD,  
        title = "Proportion of TD participants included/excluded",
        digits=0, digits.p=4,digits.pct=1, numeric.simplify=TRUE, total=FALSE, test=FALSE)
...
dx_proportions <- ggplot(motion, aes(x = Diagnosis4Levels, fill = Included))+
