...
49 Autism + 353 None = 102 ADHD_Secondary=0
...
```{r,  results="asis"}
qcMelt$Motion.Exclusion.Level <- relevel(qcMelt$Motion.Exclusion.Level, "None")
...
```{r, tidy=TRUE}
qcMelt$Motion.Exclusion.Level <- relevel(qcMelt$Motion.Exclusion.Level, "Strict")
