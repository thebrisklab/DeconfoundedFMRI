...
Next, we calculate the "true" mean functional connectivity (fconn) within the ASD group and the "true" mean within the TD group, i.e., $E[Y(1)|A=1] - E[Y(1)|A=0]$:
...
mean_fconn_asd.SL <- drtmle(Y = Y.sample.QC[A.sample==1],
                            ...
                            SL_gr = "SL.npreg",
                            maxIter = 1,
                            stratify=TRUE #ensures that unusable functional connectivity values are not used at all in model fitting
                            )
